...
//  LightPark
//
//  Created by Brian Loughran on 01/10/18.
...
class Signup_ViewController: UIViewController,UITextFieldDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate  {
    ...
    @IBAction func btn_register(_ sender: Any) {
        ...
        if txt_fname.text == ""
        {
            let alert = UIAlertController(title: "Form Error", message: "Enter First Name", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }else if txt_lname.text == ""
        {
            let alert = UIAlertController(title: "Form Error", message: "Enter Last Name", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }
        else if txt_email.text == ""
        {
            let alert = UIAlertController(title: "Form Error", message: "Enter Email", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }
        else if txt_username.text == ""
        {
            let alert = UIAlertController(title: "Form Error", message: "Enter User Name", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }
        else if txt_pass.text == ""
        {
            let alert = UIAlertController(title: "Form Error", message: "Enter Password", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }
        else if (txt_pass.text?.count)! < 8
        {
            let alert = UIAlertController(title: "Form Error", message: "Minimum 8 character Password ", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }
        else {
            ...
            ref.child("User").queryOrdered(byChild: "uname").queryEqual(toValue: txt_username.text)
                .observeSingleEvent(of: .value, with: {(snapshot: DataSnapshot) in
                    ...
                    if snapshot.exists() {
                        ...
                        let alertController = UIAlertController(title: "Form Error", message: "User Name already exists ", preferredStyle: .alert)
    ...
    func save_newuser()
    {
        ...
        MyAPIClient.sharedClient.createCustomerID() { message in
            ...
            MyAPIClient.sharedClient.createAccountID() { message in
                ...
                if (self.profilePhoto.image?.isEqual(UIImage(named: "emptyProfile")))!
                {
