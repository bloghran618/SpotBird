...
//  LightPark
//
//  Created by Brian Loughran on 11/11/19.
...
//    }
    ...
    override func viewDidLoad() {
        ...
        // set hostViewController for payment context so the app doesnt crash when you open payments
    ...
    @IBAction func logoutButtonClicked(_ sender: Any) {
        let alertController = UIAlertController(title: "Logout Confirmation", message: "Are you sure you want to logout?", preferredStyle: UIAlertControllerStyle.alert)
